      ...
      bool mute)
{
   ...
   /* History entries can carry an explicit database name (e.g.
    * "FBNeo - Arcade Games"). gfx_thumbnail_set_content_playlist()
    * already resolves that database, so do not reject them here. */
